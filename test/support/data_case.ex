defmodule AOS.DataCase do
  ...
  by setting `use AOS.DataCase, async: true`, although
  ...
  using do
    quote do
      ...
      alias AOS.{Repo, TestLegacyModel, TestModel, TestUtils}
    end
  end
