defmodule AOSWeb.DocsController do
  @moduledoc """
  ...
  def index(%{path_info: path_info} = conn, _params) when path_info == ["docs"] do
    ...
    |> send_file(200, Application.app_dir(:aos, "priv/static/docs/index.html"))
  end
  ...
  def index(%{path_info: path_info} = conn, _params) do
    ...
    |> send_file(200, Application.app_dir(:aos, "priv/static/docs/#{path}#{resource}"))
  end
